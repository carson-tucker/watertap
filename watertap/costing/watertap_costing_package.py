...
class WaterTAPCostingData(FlowsheetCostingBlockData):
    ...
    def build_global_params(self):
        ...
        self.evaporator = pyo.Block(rule=build_evaporator_cost_param_block)
        ...
        self.compressor = pyo.Block(rule=build_compressor_cost_param_block)
        ...
        self.heat_exchanger = pyo.Block(rule=build_heat_exchanger_cost_param_block)
